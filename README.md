Final result of Intro to React tutorial on https://reactjs.org/tutorial/tutorial.html

Improvement ideas from [Wrapping Up](https://reactjs.org/tutorial/tutorial.html#wrapping-up) section:
